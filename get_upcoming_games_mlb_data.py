...
your_teams = ['Milwaukee Brewers', 'Chicago Cubs']
...
def get_mlb_schedule_with_pitcher_stats(date):
    ...
    for game in games:
        ...
        if home_team in your_teams or away_team in your_teams:
...
df = get_mlb_schedule_with_pitcher_stats(today_formatted)
df.to_json("mlb_schedule_with_pitchers.json", orient="records", indent=4)
print("Saved MLB schedule to mlb_schedule_with_pitchers.json")
